...
public class VentanaPrincipal extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent evento) {
        if (evento.getSource() == calcular) {
            try {
                for (JTextField campo : new JTextField[]{campoNota1, campoNota2, campoNota3, campoNota4, campoNota5}) {
                    if (campo.getText().trim().isEmpty()) {
                        JOptionPane.showMessageDialog(this, "Debe ingresar todas las notas.", "Error", JOptionPane.WARNING_MESSAGE);
                        return;
                    }
                ...
                JOptionPane.showMessageDialog(this, "Ingrese solo valores numéricos.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
